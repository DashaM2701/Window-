...
/***/ "./src/js/modules/changeModalStatr.js":
/*!********************************************!*\
  !*** ./src/js/modules/changeModalStatr.js ***!
  \********************************************/
...
const forms = state => {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      }).catch(() => statusMassage.textContent = message.failure).finally(() => {
        clearInputs();
        setTimeout(() => {
...
/* harmony import */ var _modules_changeModalStatr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/changeModalStatr */ "./src/js/modules/changeModalStatr.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_changeModalStatr__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  (0,_modules_modules__WEBPACK_IMPORTED_MODULE_1__["default"])();
